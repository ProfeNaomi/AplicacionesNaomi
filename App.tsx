...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 bg-[linear-gradient(to_right,#e2e8f0_1px,transparent_1px),linear-gradient(to_bottom,#e2e8f0_1px,transparent_1px)] bg-[size:20px_20px] p-4 md:p-8 font-sans text-slate-900">
      <div className="max-w-5xl mx-auto bg-white rounded-3xl shadow-xl overflow-hidden border border-slate-200">
        ...
        <div className="bg-gradient-to-r from-indigo-500 to-purple-600 p-6 text-white flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-indigo-100 font-medium mt-1">Descubre cómo sumar moviéndote en la recta numérica</p>
          </div>
        </div>
        ...
        <div className="p-6 bg-slate-50 border-b border-slate-200">
          ...
          {isValid && (n1 < -100 || n1 > 100 || sum! < -100 || sum! > 100) && (
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-8">
            ...
            <div className="bg-green-50 border-2 border-green-200 rounded-3xl p-5 w-full md:w-56 text-center shadow-sm relative">
              ...
              <div className="w-full text-center text-4xl font-bold font-mono bg-white border-2 border-green-300 rounded-2xl py-3 text-green-600 h-[76px] flex items-center justify-center">
                {sum !== null ? sum : <span className="text-green-200">?</span>}
              </div>
            </div>
            ...
            <div className="mt-10 bg-indigo-50 rounded-2xl p-6 border border-indigo-100 shadow-sm">
              ...
              <ul className="space-y-4 text-indigo-800 text-lg">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <p>
                    Le sumamos <strong className="text-orange-700 text-xl">{n2}</strong>. 
                    Como es un número {n2 >= 0 ? 'positivo' : 'negativo'}, damos{' '}
                    <strong className="text-orange-700">{Math.abs(n2)}</strong> pasos hacia la{' '}
                    <strong className="text-orange-700">{n2 >= 0 ? 'derecha' : 'izquierda'}</strong>.
                    <br/>
                    <span className="text-sm text-indigo-600 mt-1 inline-block">
                      (Observa la línea <strong>{n2 >= 0 ? 'azul' : 'roja'}</strong> en la recta numérica)
                    </span>
                  </p>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <p>
                    ¡Aterrizamos en el <strong className="text-green-700 text-xl">{sum}</strong>! Ese es nuestro resultado final.
                  </p>
                </li>
              </ul>
            </div>
